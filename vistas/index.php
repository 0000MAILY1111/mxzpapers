          ...
          <div class="card">
            <div class="card-body p-3">
              <div class="row">
                <div class="col-8">
                  <div class="numbers">
                    <p class="text-sm mb-0 text-uppercase font-weight-bold">Ingresos Dia</p>
          ...
          <div class="card ">
            <div class="card-header pb-0 p-3">
              <div class="d-flex justify-content-between">
                <h6 class="mb-2">Categoía<button class="btn btn-success" onclick="mostrarfrom(true)">
                          <i class="fa fa-plus-circle"></i>Agregar</button></h6>
              </div>
            </div>
